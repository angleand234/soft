...
public class GreenhouseScheduler {
	...
	public synchronized String getThearmostat() {
		return thermostat;
	}
	...
	class LightOff implements Runnable{
		public void run() {
			System.out.println("Turning off lighs");
			light = false;
		}
	}
	...
	class WaterOff implements Runnable{
		...
		public void run() {
			// TODO Auto-generated method stub
			System.out.println("Turning greenhouse wate off");
			water = false;
		}
